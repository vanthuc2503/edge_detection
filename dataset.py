...
class TestDataset(Dataset):
    ...
    def _build_index(self):
        ...
        if self.test_data == "CLASSIC":
            ...
            images_path = [f for f in os.listdir(self.data_root) if f.endswith(('.png', '.jpg', '.jpeg'))]
            labels_path = None
    ...
    def __getitem__(self, idx):
        ...
        if self.test_data.upper() == 'CLASSIC':
            image_path = os.path.join(self.data_root, self.data_index[0][idx])
            label_path = None
        else:
...
class BipedDataset(Dataset):
    ...
    def _build_index(self):
        ...
        if self.arg.train_data.lower() == 'bsds' or self.arg.train_data.lower() == 'animated':
